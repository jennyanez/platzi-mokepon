...
const botonPlayOnline = document.getElementById("play-game-online")
...
//mascotas enemigo - juego offline
...
function iniciarJuego() {
    ...
    botonPlayOnline.addEventListener('click', startGameOnline)
...
function joinGame(){
    fetch("http://172.20.10.3:8080/join")
        .then(function (res) {
            console.log(res)
            if(res.ok){
                res.text()
...
function seleccionarMokepon(mascotaJugador) {
    fetch(`http://172.20.10.3:8080/mokepon/${jugadorId}`, {
        method: "post",
        headers: {
...
function enviarPosicion(x, y){
    fetch(`http://172.20.10.3:8080/mokepon/${jugadorId}/posicion`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
...
function enviarAtaques() {
    fetch(`http://172.20.10.3:8080/mokepon/${jugadorId}/ataques`, {
        method: "post",
        headers: {
            "Content-Type": "application/json"
        },
...
function obtenerAtaques(){
    fetch(`http://172.20.10.3:8080/mokepon/${enemigoId}/ataques`)
        .then(function (res){
            if(res.ok){
                res.json()
